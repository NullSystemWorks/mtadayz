...
function dxWindowRender(element)
	...
	if (getElementData(element,"Title:visible")) then
		...
		dxDrawImageSection(titlex+getElementData(theme,"TitleBarTopLeft"..clickedset..":Width"),titley,
			...
			,getElementData(theme,"TitleBarTop"..clickedset..":Height"),
			getElementData(theme,"TitleBarTop"..clickedset..":X"),getElementData(theme,"TitleBarTop"..clickedset..":Y"),
			getElementData(theme,"TitleBarTop"..clickedset..":Width"),getElementData(theme,"TitleBarTop"..clickedset..":Height"),
			getElementData(theme,"TitleBarTop"..clickedset..":images"),0,0,0,color,cpg)
		---getElementData(theme,"TitleBarTopLeft"..clickedset..":Width")-getElementData(theme,"TitleBarTopRight"..clickedset..":Width")
		dxDrawImageSection(titlex,titley+getElementData(theme,"TitleBarTopLeft"..clickedset..":Height"),
			w,
			titleHeight,
	...
	if not (getElementData(element,"Title:visible")) then
		titleHeight = 0
	end
	--[[dxDrawImageSection(x+leftw,y+titleHeight-1,w-leftw-rightw,getElementData(theme,"Frame2Top:Height"),
		...
		dxDrawImageSection(x,y+titleHeight-1,w,getElementData(theme,"Frame2Top:Height"),
			getElementData(theme,"Frame2Top:X"),getElementData(theme,"Frame2Top:Y"),
			getElementData(theme,"Frame2Top:Width"),getElementData(theme,"Frame2Top:Height"),
			getElementData(theme,"Frame2Top:images"),0,0,0,tocolor(r,g,b,a),cpg)
	dxDrawImageSection(x,y+titleHeight-1,leftw,h+getElementData(theme,"Frame2Top:Height"),
	...
	dxDrawImageSection(x+leftw,y+titleHeight-1+getElementData(theme,"Frame2Top:Height"),w-leftw-rightw,h,
	...
	dxDrawImageSection(x+(w-leftw),y+titleHeight-1,rightw,h+getElementData(theme,"Frame2Top:Height"),
	...
	dxDrawImageSection(x,y+titleHeight-1+h+getElementData(theme,"Frame2Top:Height"),getElementData(theme,"Frame2BottomLeft:Width"),getElementData(theme,"Frame2BottomLeft:Height"),
	...
	dxDrawImageSection(x+getElementData(theme,"Frame2BottomLeft:Width"),y+titleHeight+getElementData(theme,"TitleBarTopLeft:Height")-1+h,w-getElementData(theme,"Frame2BottomLeft:Width")-getElementData(theme,"Frame2BottomRight:Width"),getElementData(theme,"Frame2Bottom:Height"),
	...
	dxDrawImageSection(x+(w-leftw),y+titleHeight-1+h+getElementData(theme,"Frame2Top:Height"),getElementData(theme,"Frame2BottomRight:Width"),getElementData(theme,"Frame2BottomRight:Height"),
