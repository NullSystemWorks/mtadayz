...
function addGangMember(gangName, memberAccount, playerName, addedBy)
	if not doesGangExists(gangName) then
		return false, "The gang doesn't exists."
	end
	...
	if executeSQLInsert("gang_members", "'" .. tostring(gangName) .. "','" .. tostring(memberAccount) .. "','" ..tostring(playerName).. "','" .. tostring(addedBy) .. "'") then
