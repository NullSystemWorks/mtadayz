	...
	for i,data in ipairs(playerDataTable) do
		...
		elseif data[1] =="skin" then
			if getElementData(player,"gender") then
				...
				setElementData(player,data[1],40)
			end
...
function kilLDayZPlayer (killer,headshot,weapon)
	...
	if pedCol then
		...
		-- NEW BACKPACKS!
		elseif backpackSlots == 20 then
			setElementData(pedCol,"British Assault Pack",1)
		elseif backpackSlots == 15 then
			setElementData(pedCol,"Camouflage Assault Pack",1)
		elseif backpackSlots == 21 then
		...
		elseif backpackSlots == 40 then
			setElementData(pedCol,"Ghillie Pack",1)
		elseif backpackSlots == 22 then
			setElementData(pedCol,"Light Backpack",1)
		elseif backpackSlots == 45 then
			setElementData(pedCol,"Military Backpack",1)
		elseif backpackSlots == 35 then
			setElementData(pedCol,"OS Pack",1)
		elseif backpackSlots == 14 then
			setElementData(pedCol,"RSS Assault Pack",1)
		elseif backpackSlots == 23 then
			setElementData(pedCol,"Soldier Pack",1)
		end
	end
