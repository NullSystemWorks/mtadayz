...
itemTXD = engineLoadTXD(":DayZ/models/items/txd/backpack_small.txd")
engineImportTXD(itemTXD, 3026)
itemDFF = engineLoadDFF(":DayZ/models/items/dff/backpack_small.dff", 3026)
...
itemDFF = engineLoadDFF(":DayZ/models/items/dff/backpack_alice.dff", 1248)
...
itemTXD = engineLoadTXD(":DayZ/models/items/txd/backpack_ghillie.txd")
engineImportTXD(itemTXD, 1275)
itemDFF = engineLoadDFF(":DayZ/models/items/dff/backpack_ghillie.dff", 1275)
engineReplaceModel(itemDFF, 1275)
itemTXD = engineLoadTXD(":DayZ/models/items/txd/backpack_os.txd")
engineImportTXD(itemTXD, 1644)
itemDFF = engineLoadDFF(":DayZ/models/items/dff/backpack_os.dff", 1644)
