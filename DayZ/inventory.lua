...
{400,4,1,1},
{471,4,1,1},
{511,0,2,1}, -- AIRPLANE! [XR1]
{568,4,1,1},
--{548,0,2,1}, -- CARGOBOB! [XR2]
}
...
elseif itemName == "Coyote Backpack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 50 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You already have the best backpack!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",50)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
-- NEW BACKPACKS!
elseif itemName == "British Assault Pack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 15 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 15 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",15)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "Camouflage Assault Pack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 20 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 20 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",20)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "Camp Backpack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 21 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 21 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",21)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "Krysset Backpack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 13 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 13 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",13)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "Ghillie Pack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 40 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 40 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",40)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "Light Backpack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 22 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 22 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
...
elseif itemName == "Military Backpack" then
	...
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "OS Pack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 35 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 35 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",35)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "RSS Assault Pack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 14 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 14 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",14)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
elseif itemName == "Soldier Pack" then
	if getElementData(getLocalPlayer(),"MAX_Slots") == 23 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","You are using this backpack already!",255,22,0) return end
	if getElementData(getLocalPlayer(),"MAX_Slots") > 23 then triggerEvent (getLocalPlayer(), "displayClientInfo", getLocalPlayer(),"Inventory","The currently equipped backpack has more space!",255,22,0) return end
	setElementData(getLocalPlayer(),"MAX_Slots",23)
	setElementData(loot,itemName,getElementData(loot,itemName)-1)
	itemPlus = 0
end
	if loot then
