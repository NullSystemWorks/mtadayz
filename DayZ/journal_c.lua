...
function showJournal()
	if getElementData(localPlayer,"logedin") then
		if not isJournalOpen then
			...
			playSound("sounds/journal.wav",false)
...
function initJournal()
	JournalTable.image[1] = guiCreateStaticImage(0.00, 0.06, 1.00, 0.90, "images/journal/journal_page1.png", true)
